...
export var normal_speed = 750
export var dash_speed = 1900
export var crouch_speed = 450
var speed = normal_speed
var velocity = Vector2.ZERO
var input_velocity = Vector2.ZERO
export var normal_accel = 80
export var normal_deccel = 80
...
func _process(_delta):
	...
	if ability_active == false:
		$Stun_Effect/ColorRect.color = lerp($Stun_Effect/ColorRect.color, Color(1, 1, 1, 0), 0.05)
...
func ability():
	...
	if $Ability_Cooldown.time_left == 0:
		if  ability_active:
			$Stun_Effect/ColorRect.color = Color(1, 1, 1, 1)
			ability_active = false
			get_tree().call_group("enemy", "stunned")
